...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Pumpkin soup')
        recipe2 = sample_recipe(user=self.user, title='Rice with weggies')
        tag1 = sample_tag(user=self.user, name='vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Milk soup')
        ...
        recipe3 = sample_recipe(user=self.user, title='Risotto')
